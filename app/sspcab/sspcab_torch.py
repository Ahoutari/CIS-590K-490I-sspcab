...
class SSPCAB(nn.Module):
    def __init__(self, channels, kernel_dim=1, dilation=1, reduction_ratio=8):
        ...
        self.conv_transpose = nn.ConvTranspose2d(channels, channels, kernel_size=kernel_dim, stride=2, padding=1, output_padding=1)
    ...
    def forward(self, x):
        ...
        mse_loss = nn.MSELoss()
        cost_sspcab = mse_loss(x, output)
        
        self.cost = cost_sspcab
